...
Casual classic bike ride numbers remain low when the maximum temperature is 10°C or below. Casual e-bike rides start increasing when the maximum temperature reaches 0°C. TCasual ride numbers appear to decline once the maximum temperature reaches 30 degrees.

Member rides remain at a consistent level right though winter.
There are similar numbers of electric and classic rides taken during this period. Members show a preference for E-bikes when the temperatures are below 15°C.
...
This suggests that E-bikes encourage users to ride when maximum temperatures are in the range of -10°C to +15°C, or above 30°C.
