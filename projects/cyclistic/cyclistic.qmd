...
```
The plot indicates that November has far higher percentage of rides with negative durations than other months.
This appears to be due to the end of daylight savings at 2.00am on 7 November 2021.

Ride start and end timestamps do not provide timezone data. As a result rides which included the timezone change may appear to be one hour shorter than actual ride time.
